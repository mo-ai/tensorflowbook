...
with graph.as_default():
    ...
    with tf.name_scope("summaries"):
        tf.summary.scalar("output_summary", output, family='output')  # Creates summary for output node
        tf.summary.scalar("prod_summary", b, family='prod')
        tf.summary.scalar("sum_summary", c, family='sum')
...
writer = tf.train.summary.FileWriter('./improved_graph', graph)
